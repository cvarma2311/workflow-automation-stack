...
def memory_profiler(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        # When a Java subprocess is launched, its memory usage contributes to the
        # Python process's RSS (Resident Set Size) and VMS (Virtual Memory Size).
        # This provides an overall view of the resources consumed by the task,
        # but does not offer granular JVM-specific metrics (e.g., heap, GC details)
        # or per-line memory usage of the Java code.
